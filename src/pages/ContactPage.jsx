  ...
  return (
    <>
      <style>{`
        ...
        .c-row { display: flex; gap: 20px; margin-bottom: 16px; }
        .c-field { display: flex; flex-direction: column; flex: 1; gap: 6px; }
        ...
        .c-input {
          ...
          color: #FDF9F5; outline: none;
          transition: border-color 0.2s ease, background 0.2s ease;
          resize: none; width: 100%;
        }
        .c-input::placeholder { color: rgba(253,249,245,0.3); }
        .c-input:focus { border-color: var(--pink); background: rgba(253,249,245,0.14); }
        textarea.c-input { height: 86px; line-height: 1.6; }

        .c-submit {
          margin-top: 18px; padding: 13px 36px;
          background: #FDF9F5; color: #5862E9;
          border: none; border-radius: 100vw;
          font-family: 'Poppins', sans-serif; font-size: 0.75rem;
          font-weight: 600; letter-spacing: 0.14em; text-transform: uppercase;
          cursor: pointer; transition: background 0.2s ease, color 0.2s ease, transform 0.18s ease;
        }
        .c-submit:hover { background: var(--red); color: #FDF9F5; transform: translateY(-2px); }
        .c-submit:active { transform: translateY(0); }

        .c-sent {
          display: flex; flex-direction: column; align-items: center;
          justify-content: center; min-height: 200px; gap: 10px; text-align: center;
        }
        ...
        .c-info { flex: 0.8; display: flex; flex-direction: column; gap: 0; }
        ...
        .c-info-icon { font-size: 0.95rem; margin-bottom: 4px; }
        .c-info-label {
        ...
        .c-info-value {
          ...
          transition: color 0.2s ease; font-family: 'Poppins', sans-serif;
        }
        ...
        .c-footer {
          ...
          z-index: 3; border-top: 1px solid var(--divider); padding-top: 16px;
        }
        .c-footer-logo {
          font-family: 'Italianno', cursive; font-size: 1.6rem;
          color: var(--pink); text-decoration: none; cursor: pointer;
        }
        .c-footer-copy { font-size: 0.65rem; color: var(--text-muted); letter-spacing: 0.08em; }
        ...
        @media (max-width: 768px) {
          ...
          .c-info { width: 100%; }
          .c-section { padding: 48px 24px 100px; }
        ...
        <section className="c-section">
          ...
          <div className="c-body">
            <div className="c-card-wrap">
              <div className="c-card" ref={cardRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
                {sent ? (
          ...
          <footer className="c-footer">
            <span className="c-footer-logo" onClick={() => navigate('/home')}>vrinda</span>
